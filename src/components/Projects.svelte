            ...
            >
              ...
              <div class="project-card glass-glow glass">
                ...
                <div class="project-image">
                  ...
                  <div class="glass-capsules-container">
...
<style>
  ...
  .timeline-dot {
    ...
    z-index: 5;
    transition: border-color 0.5s ease, box-shadow 0.5s ease, background 0.5s ease, transform 0.4s ease;
  }

  .dot-right { right: -38px; }
  .dot-left { left: -38px; }
  ...
  .project-card:hover .glass-capsule:nth-child(1) { transition-delay: 0ms; }
  .project-card:hover .glass-capsule:nth-child(2) { transition-delay: 40ms; }
  .project-card:hover .glass-capsule:nth-child(3) { transition-delay: 80ms; }
  .project-card:hover .glass-capsule:nth-child(4) { transition-delay: 120ms; }
  .project-card:hover .glass-capsule:nth-child(5) { transition-delay: 160ms; }
